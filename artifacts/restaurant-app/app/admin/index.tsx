...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, RefreshControl, useColorScheme, Platform } from "react-native";
        ...
        {stats && (
          <>
            ...
            <View style={styles.statsGrid}>
              <StatCard label="Total Orders" value={stats.totalOrders} icon="receipt-outline" color={Colors.primary} theme={theme} />
              <StatCard label="Revenue" value={`$${stats.totalRevenue.toFixed(0)}`} icon="cash-outline" color={Colors.success} theme={theme} />
              <StatCard label="Pending" value={stats.pendingOrders} icon="time-outline" color={Colors.warning} theme={theme} />
              <StatCard label="Preparing" value={stats.preparingOrders} icon="flame-outline" color={Colors.secondary} theme={theme} />
              <StatCard label="Customers" value={stats.totalCustomers} icon="people-outline" color={Colors.primary} theme={theme} />
              <StatCard label="Meals" value={stats.totalMeals} icon="restaurant-outline" color={Colors.secondary} theme={theme} />
            </View>
            ...
            <View style={[styles.section, { backgroundColor: theme.card }]}>
              ...
              <View style={styles.actionsGrid}>
                {[
                  { label: "All Orders", icon: "list-outline", route: "/admin/orders" },
                  { label: "Manage Meals", icon: "restaurant-outline", route: "/admin/meals" },
